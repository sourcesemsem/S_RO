...
__author__ = "ZED_USERBOT <https://github.com/Zedthon/ZED_USERBOT>"
__copyright__ = "Zedthon Copyright (C) 2020 - 2021  " + __author__
...
if Config.UPSTREAM_REPO == "goodcat":
    UPSTREAM_REPO_URL = "https://github.com/Zedthon/ZED_USERBOT"
