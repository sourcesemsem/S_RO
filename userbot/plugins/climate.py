...
@icssbot.on(admin_cmd(outgoing=True, pattern="climate( (.*)|$)"))
@icssbot.on(sudo_cmd(pattern="climate( (.*)|$)", allow_sudo=True))
@errors_handler
...
@icssbot.on(admin_cmd(outgoing=True, pattern="setcity(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="setcity(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@icssbot.on(admin_cmd(pattern="weather ?(.*)"))
@icssbot.on(sudo_cmd(pattern="weather ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="wttr ?(.*)"))
@icssbot.on(sudo_cmd(pattern="wttr ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
