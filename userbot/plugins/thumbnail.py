...
@icssbot.on(admin_cmd(pattern="savethumb$"))
@icssbot.on(sudo_cmd(pattern="savethumb$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    if event.reply_to_msg_id:
        ...
        await icse.edit("Reply to a photo to save custom thumbnail")


@icssbot.on(admin_cmd(pattern="clearthumb$"))
@icssbot.on(sudo_cmd(pattern="clearthumb$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="getthumb$"))
@icssbot.on(sudo_cmd(pattern="getthumb$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
