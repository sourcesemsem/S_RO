...
@icssbot.on(admin_cmd(outgoing=True, pattern="lastfm$"))
...
@icssbot.on(admin_cmd(outgoing=True, pattern=r"lastbio (on|off)"))
...
@icssbot.on(admin_cmd(outgoing=True, pattern=r"lastlog (on|off)"))
