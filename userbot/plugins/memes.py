...
@icssbot.on(admin_cmd(outgoing=True, pattern=r"(\w+)say (.*)"))
@icssbot.on(sudo_cmd(pattern="(\w+)say (.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="coin ?(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="coin ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    if r % 2 == 1:
        if input_str == "heads":
            await edit_or_reply(
                event, "⌔∮ العمله هبطت على : **heads**. \n ⪼ اختيارك صحيح استمر."
            )
        elif input_str == "tails":
            await edit_or_reply(
                event,
                "⌔∮ العمله هبطت على : **Heads**. \n ⪼ اختيارك خاطئ، اعد المحاوله مجددا. ",
            )
        else:
        ...
        if input_str == "tails":
            ...
            await edit_or_reply(event, "⌔∮ العمله هبطت على : **Tails**.")
    else:
        await edit_or_reply(event, r"¯\_(ツ)_/¯")


@icssbot.on(admin_cmd(pattern=r"slap(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="slap(?: |$)(.*)", allow_sudo=True))
async def who(event):
...
@icssbot.on(admin_cmd(outgoing=True, pattern="(yes|no|maybe|decide)$"))
@icssbot.on(sudo_cmd(pattern="(yes|no|maybe|decide)$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern=f"shout", outgoing=True))
@icssbot.on(sudo_cmd(pattern=f"shout", allow_sudo=True))
...
@icssbot.on(admin_cmd(outgoing=True, pattern="owo ?(.*)"))
@icssbot.on(sudo_cmd(pattern="owo ?(.*)", allow_sudo=True))
async def faces(owo):
...
@icssbot.on(admin_cmd(outgoing=True, pattern="clap(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="clap(?: |$)(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(outgoing=True, pattern="smk(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="smk(?: |$)(.*)", allow_sudo=True))
async def smrk(smk):
...
@icssbot.on(admin_cmd(pattern="wish ?(.*)"))
@icssbot.on(sudo_cmd(pattern="wish ?(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="gbun", outgoing=True))
@icssbot.on(sudo_cmd(pattern="gbun", allow_sudo=True))
