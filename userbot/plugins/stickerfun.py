...
@icssbot.on(admin_cmd(outgoing=True, pattern="sttxt(?: |$)(.*)"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern="sttxt(?: |$)(.*)"))
...
@icssbot.on(admin_cmd(pattern=r"stcr ?(?:(.*?) \| )?(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern=r"stcr ?(?:(.*?) \| )?(.*)", allow_sudo=True))
async def sticklet(event):
    ...
    image_stream.name = "@rruuurr.webp"
