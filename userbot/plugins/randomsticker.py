...
@icssbot.on(admin_cmd(pattern="cat$"))
@icssbot.on(sudo_cmd(pattern="cat$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    try:
...
@icssbot.on(admin_cmd(pattern="dab$", outgoing=True))
@icssbot.on(sudo_cmd(pattern="dab$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="brain$", outgoing=True))
@icssbot.on(sudo_cmd(pattern="brain$", allow_sudo=True))
async def handler(event):
    blacklist = {}
    try:
        await event.delete()
