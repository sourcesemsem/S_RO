...
@icssbot.on(admin_cmd(pattern="frwd$"))
@icssbot.on(sudo_cmd(pattern="frwd$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="resend$"))
@icssbot.on(sudo_cmd(pattern="resend$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    try:
...
@icssbot.on(admin_cmd(pattern=r"fpost (.*)"))
@icssbot.on(sudo_cmd(pattern=r"fpost (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    try:
