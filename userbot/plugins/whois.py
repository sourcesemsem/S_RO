# whois code for sad edit by ~ @ZedThon
...
async def fetch_info(replied_user, event):
    ...
    caption = "<b> 𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙕𝞝𝘿𝙏𝙃𝙊𝙉 - 𝑷𝑹𝑶 𝑫𝑨𝑻𝑨 𓆪 </b>\n"
    caption += f"<b> 𓍹ⵧⵧⵧⵧⵧℤ𝔼𝔻𝕋ℍ𝕆ℕⵧⵧⵧⵧⵧ𓍻 </b>\n"
    caption += f"<b> • 🖤 | الاسم 𓆩</b> {first_name} {last_name}\n"
    caption += f"<b> • 🖤 | المعرف 𓆩</b> {username}\n"
    caption += f"<b> • 🖤 | الايدي 𓆩</b> <code>{user_id}</code>\n"
    caption += f"<b> • 🖤 | عدد الصور 𓆩</b> {replied_user_profile_photos_count}\n"
    caption += f"<b> • 🖤 | البايو ↬ </b> {user_bio} \n"
    caption += f"<b> • 🖤 | الحساب 𓆩</b> "
    caption += f'<a href="tg://user?id={user_id}">{first_name}</a>/n'
    caption += f"<b> 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧℤ𝔼𝔻𝕋ℍ𝕆ℕⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 </b>  - @Zedthon 𓆪 "
