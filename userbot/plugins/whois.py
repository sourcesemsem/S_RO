...
async def fetch_info(replied_user, event):
    ...
    caption += f"<b> • 🖤 | 𓆩الاسم </b> {first_name} {last_name}\n"
    caption += f"<b> • 🖤 | 𓆩المعرف </b> {username}\n"
    caption += f"<b> • 🖤 | 𓆩الايدي </b> <code>{user_id}</code>\n"
    caption += f"<b> • 🖤 | 𓆩عدد الصور </b> {replied_user_profile_photos_count}\n"
    caption += f"<b> • 🖤 | 𓆩البايو ↬ </b> {user_bio} \n"
    caption += f"<b> • 🖤 | 𓆩الحساب </b> "
    caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
    caption += f"\n<b> 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧℤ𝔼𝔻𝕋ℍ𝕆ℕⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
