...
'''
mm = '''
قم بلأنضمام الى قناة ريبثون @Repthon
'''
...
keyboard = [
  ...
  [
    Button.url("سورس ريبثون 🧸❤️", "https://t.me/Repthon")
    ]
]
...
async def op(event):
    ...
    await event.edit(f"**᯽︙ قم بالدخول لبوتك من هنا @{rep} \n وكتابة الامر /hack** ")
  ...
  if event.sender_id == bot.uid:
      async with bot.conversation(event.chat_id) as x:
        keyboard = [
          ...
          [
            Button.url("المطور", "https://t.me/E_7_V")
            ]
        ]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\nشكرا لأستخدامك سورس ريبـــثون", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم حذف القناة/الكروب شكرا لأستخدامك ريبـــثون.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك ريبـــثون.", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/Repthon")
        ]
    ]
