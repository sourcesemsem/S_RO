...
@icssbot.on(admin_cmd(pattern=f"({DART_E_MOJI}|سهم)( ([1-6])|$)"))
@icssbot.on(
    sudo_cmd(
...
@icssbot.on(admin_cmd(pattern=f"({DICE_E_MOJI}|نرد)( ([1-6])|$)"))
@icssbot.on(
    sudo_cmd(
...
@icssbot.on(admin_cmd(pattern=f"({BALL_E_MOJI}|سلة)( ([1-5])|$)"))
@icssbot.on(
    sudo_cmd(
...
@icssbot.on(admin_cmd(pattern=f"({FOOT_E_MOJI}|قدم)( ([1-5])|$)"))
@icssbot.on(
    sudo_cmd(
...
@icssbot.on(admin_cmd(pattern=f"({SLOT_E_MOJI}|حظ)( ([1-64])|$)"))
@icssbot.on(
    sudo_cmd(
...
CMD_HELP.update(
    {
        "emojigames": "**Syntax :** `.🎯 [1-6]` or `.سهم [1-6]`\
