...
CMD_HELP.update(
    {
        ...
        \n**الشـرح ⦂ **لـ تحميـل التطبيقـات والالعـاب غير محدود وبأحجـام كبيـره تصـل الى 2 جيجـا بايت .. قـم بكتابـة الاسـم بالانجلـش بطـريقـه صحيحـه والا فلن يستطيـع البـوت التعـرف ع طلبـك او قم اولاً باستخـدام الامر `.متجر + اسم التطبيق` بالعربي للحصول ع اسم التطبيق بالانجلـش .. حصـرياً فقـط ع سـورس ريسثــون ™✓ \
        \n\n**╮•❐ الامـر ⦂ **`.فلم + اسـم الفلـم`\
        \n**الشـرح ⦂ **لـ تحميـل الافـلام الاجنبيـه بدقـه عاليـه قم بكتابـة الاسـم بالانجلـش بطـريقـه صحيحـه والا فلن يستطيـع البـوت التعـرف ع طلبـك .. حصـرياً فقـط ع سـورس ريسثــون ™✓ \
