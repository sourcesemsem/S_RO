...
@icssbot.on(admin_cmd(pattern="repeat (\d*) (.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="repeat (\d*) (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern=f"meme", outgoing=True))
@icssbot.on(sudo_cmd(pattern=f"meme", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern=f"give", outgoing=True))
@icssbot.on(sudo_cmd(pattern=f"give", allow_sudo=True))
