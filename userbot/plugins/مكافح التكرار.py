...
async def _(event):
    ...
    try:
        ...
        no_admin_privilege_message = await event.client.send_message(
            ...
            message="""** مكافـح السبام التلقائـي**
@admin [User](tg://user?id={}) **يقوم بالتكرار ويزعج الاعضاء**
`{}`""".format(
        ...
        await event.client.send_message(
            entity=event.chat_id,
            message="""** مكافـح السبام التلقائـي**
[User](tg://user?id={}) ** تم تقييده تلقائيًا
لأنه وصل إلى حد التكـرار المحـدد ... **""".format(
