...
@icssbot.on(admin_cmd(pattern="انتحار (.*)"))
@icssbot.on(sudo_cmd(pattern="انتحار (.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="اقتل (.*)"))
@icssbot.on(sudo_cmd(pattern="اقتل (.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern=r"طياره$"))
@icssbot.on(sudo_cmd(pattern="طياره$", allow_sudo=True))
async def bluedevilhmf(hmf):
    await edit_or_reply(hmf, G)


@icssbot.on(admin_cmd(pattern=r"حبي$"))
@icssbot.on(sudo_cmd(pattern="حبي$", allow_sudo=True))
async def bluedevilcouple(couple):
    await edit_or_reply(couple, H)


@icssbot.on(admin_cmd(pattern=r"سوبر$"))
@icssbot.on(sudo_cmd(pattern="سوبر$", allow_sudo=True))
async def bluedevilsupreme(supreme):
    await edit_or_reply(supreme, I)


@icssbot.on(admin_cmd(pattern=r"الهند$"))
@icssbot.on(sudo_cmd(pattern="الهند$", allow_sudo=True))
async def bluedevilindia(india):
    await edit_or_reply(india, J)


@icssbot.on(admin_cmd(pattern=r"هلا$"))
@icssbot.on(sudo_cmd(pattern="هلا$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern=r"خرا$"))
@icssbot.on(sudo_cmd(pattern="خرا$", allow_sudo=True))
