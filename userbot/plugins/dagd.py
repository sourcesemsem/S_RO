...
@icssbot.on(admin_cmd(pattern="dns( (.*)|$)"))
@icssbot.on(sudo_cmd(pattern="dns( (.*)|$)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="url( (.*)|$)"))
@icssbot.on(sudo_cmd(pattern="url( (.*)|$)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = "".join(event.text.split(maxsplit=1)[1:])
...
@icssbot.on(admin_cmd(pattern="unshort( (.*)|$)"))
@icssbot.on(sudo_cmd(pattern="unshort( (.*)|$)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = "".join(event.text.split(maxsplit=1)[1:])
...
# By Priyam Kalra
@icssbot.on(admin_cmd(pattern="hl( (.*)|$)"))
@icssbot.on(sudo_cmd(pattern="hl( (.*)|$)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = "".join(event.text.split(maxsplit=1)[1:])
