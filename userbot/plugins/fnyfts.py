...
@icssbot.on(admin_cmd(pattern="str(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="str(?: |$)(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="zal(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="zal(?: |$)(.*)", allow_sudo=True))
async def zal(zgfy):
    reply_text = list()
...
@icssbot.on(admin_cmd(pattern="cp(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="cp(?: |$)(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="weeb(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="weeb(?: |$)(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="downside(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="downside(?: |$)(.*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="subscript(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="subscript(?: |$)(.*)", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="superscript(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="superscript(?: |$)(.*)", allow_sudo=True))
async def stylish_generator(event):
    args = event.pattern_match.group(1)
    if not args:
        get = await event.get_reply_message()
