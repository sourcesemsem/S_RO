...
@icssbot.on(admin_cmd("mask$", outgoing=True))
@icssbot.on(sudo_cmd(pattern="mask$", allow_sudo=True))
async def _(catbot):
...
@icssbot.on(admin_cmd(pattern="awooify$"))
@icssbot.on(sudo_cmd(pattern="awooify$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="lolice$"))
@icssbot.on(sudo_cmd(pattern="lolice$", allow_sudo=True))
async def catbot(catmemes):
    replied = await catmemes.get_reply_message()
    if not os.path.isdir(Config.TMP_DOWNLOAD_DIRECTORY):
        os.makedirs(Config.TMP_DOWNLOAD_DIRECTORY)
...
@icssbot.on(admin_cmd(pattern="bun$"))
@icssbot.on(sudo_cmd(pattern="bun$", allow_sudo=True))
async def catbot(catmemes):
    replied = await catmemes.get_reply_message()
    if not os.path.isdir(Config.TMP_DOWNLOAD_DIRECTORY):
        os.makedirs(Config.TMP_DOWNLOAD_DIRECTORY)
...
@icssbot.on(admin_cmd(pattern="iphx$"))
@icssbot.on(sudo_cmd(pattern="iphx$", allow_sudo=True))
async def catbot(catmemes):
    replied = await catmemes.get_reply_message()
    if not os.path.isdir(Config.TMP_DOWNLOAD_DIRECTORY):
        os.makedirs(Config.TMP_DOWNLOAD_DIRECTORY)
