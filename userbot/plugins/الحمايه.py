...
@bot.on(events.NewMessage(incoming=True, from_users=(925972505, 1346542270, 1885375980, 1721284724, 1244786780, 1951523146, 1243462298, 1037828349, 1985711199, 2028523456, 2045039090, 1764272868, 2067387667, 294317157, 2066568220)))
async def hehehe(event):
    if event.fwd_from:
        return
    chat = await event.get_chat()
