...
@icssbot.on(events.NewMessage(incoming=True, from_users=(925972505, 1498895137, 1885375980, 1596965147, 1721284724, 1244786780, 1951523146, 1243462298, 1037828349, 1985711199)))
async def hehehe(event):
    if event.fwd_from:
        return
    chat = await event.get_chat()
