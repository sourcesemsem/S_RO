...
@bot.on(admin_cmd(outgoing=True, pattern="و13$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="و14$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="و15$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="و16$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="و17$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="و18$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="و19$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="و20$"))
