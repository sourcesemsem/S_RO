...
@zedthon.on(zelzal_cmd(pattern="ضع صوره$"))
@zedthon.on(sudo_cmd(pattern="ضع صوره$", allow_sudo=True))
...
@zedthon.on(zelzal_cmd(pattern="رفع مشرف(?: |$)(.*)", command="promote"))
@zedthon.on(sudo_cmd(pattern="رفع مشرف(?: |$)(.*)", command="promote", allow_sudo=True))
async def promote(promt):
    ...
    zedl = await eor(promt, "**╮ ❐  جـاري ࢪفعه مشرف  ❏╰**")
    ...
    try:
        ...
        await zedl.edit("**- ❝ ⌊  تم تـرقيتـه مشـرف 𓆰.**")
    except BadRequestError:
        await zedl.edit(NO_PERM)
        return
    if BOTLOG:
...
@zedthon.on(zelzal_cmd(pattern="رفع مالك(?: |$)(.*)", command="promote"))
@zedthon.on(sudo_cmd(pattern="رفع مالك(?: |$)(.*)", command="promote", allow_sudo=True))
async def promote(promt):
    if promt.fwd_from:
        return
    chat = await promt.get_chat()
    ...
    zedl = await eor(promt, "**╮ ❐  جـاري ࢪفعه مالك  ❏╰**")
    user, rank = await get_user_from_event(promt)
    if not rank:
        rank = "🝢 المالك"
    if not user:
    ...
    try:
        await promt.client(EditAdminRequest(promt.chat_id, user.id, new_rights, rank))
        await zedl.edit("**- ❝ ⌊  تم تـرقيتـه مالك 𓆰.**")
    except BadRequestError:
        await zedl.edit(NO_PERM)
        return
    if BOTLOG:
...
@zedthon.on(zelzal_cmd(pattern="تنزيل مشرف(?: |$)(.*)", command="demote"))
@zedthon.on(sudo_cmd(pattern="تنزيل مشرف(?: |$)(.*)", command="demote", allow_sudo=True))
async def demote(dmod):
    ...
    try:
        ...
        await zedl.edit(NO_PERM)
        return
    await zedl.edit("**- ❝ ⌊  تم تنزلـيه من الاشـرف بنجـاح  𓆰.**")
    if BOTLOG:
...
@zedthon.on(zelzal_cmd(pattern="حظر(?: |$)(.*)", command="ban"))
@zedthon.on(sudo_cmd(pattern="حظر(?: |$)(.*)", command="ban", allow_sudo=True))
async def ban(bon):
    if bon.fwd_from:
        return
    chat = await zedj.get_chat()
    admin = chat.admin_rights
    creator = chat.creator
    if not admin and not creator:
        await eor(zedj, NO_ADMIN)
        return
    user, reason = await get_user_from_event(zedj)
    if not user:
        return
    zedl = await eor(bon, "**╮ ❐... جـاࢪِ الحـظـࢪ ...❏╰**")
    try:
    ...
    try:
        ...
        return
    if reason:
        await zedl.edit(f"`{str(user.id)}` محظور !!\n دقيقه: {reason}")
    else:
        await zedl.edit(f"`{str(user.id)}` محظور !!")
    if BOTLOG:
...
@zedthon.on(zelzal_cmd(pattern="الغاء حظر(?: |$)(.*)", command="unban"))
@zedthon.on(sudo_cmd(pattern="الغاء حظر(?: |$)(.*)", command="unban", allow_sudo=True))
async def nothanos(unbon):
    ...
    if not admin and not creator:
        ...
        return
    zedl = await eor(unbon, "**╮ ❐  جـاري رفـع الحظـر  ❏╰**")
    ...
    try:
        ...
        await zedj.edit("**تم رفع الحظـر عنـه...**")
        if BOTLOG:
        ...
        await zedl.edit("**- ❝ ⌊  تم الغـاء الحظـر .. بنجـاح  𓆰.**")
...
@zedthon.on(zelzal_cmd(pattern="كتم(?: |$)(.*)", command="mute"))
@zedthon.on(sudo_cmd(pattern="كتم(?: |$)(.*)", command="mute", allow_sudo=True))
async def startmute(event):
    if event.fwd_from:
        return
    if event.is_private:
        await event.edit("**╮ ❐  جـاري كتمه  ❏╰**")
        await sleep(3)
        ...
        if is_muted(userid, chat_id):
            return await event.edit("**╮ ❐ المسـتخدم مكتوم بالفعـل  ❏╰**")
        try:
            mute(userid, chat_id)
        except Exception as e:
            await event.edit("حدث خطأ!\nالخطأ هو " + str(e))
        else:
            await event.edit("**╮ ❐ تم كتـمه  ❏╰**")
        if BOTLOG:
        ...
        if not user:
            return
        if user.id == bot.uid:
            return await eor(event, "**- ❝ ⌊  لا استـطيع كتـم نفـسي  𓆰.**")
        if is_muted(user.id, event.chat_id):
            return await eor(event, "**╮ ❐ المسـتخدم مكتوم بالفعـل  ❏╰**")
        try:
            admin = chat.admin_rights
            creator = chat.creator
            if not admin and not creator:
                await eor(
                    event, "** ⪼ لا استطيع كتـم شخص بـدون صلاحـيات الشرفـين 𓆰،** "
                )
                return
        ...
        if reason:
            await eor(
                event,
                f" المستخدم ↫[{user.first_name}](tg://user?id={user.id})تم كتمه بنجاح✅"
                #                 f"`Reason:`{reason}",
            )
        else:
            await eor(
...
@zedthon.on(zelzal_cmd(pattern="الغاء كتم(?: |$)(.*)", command="unmute"))
@zedthon.on(sudo_cmd(pattern="الغاء كتم(?: |$)(.*)", command="unmute", allow_sudo=True))
async def endmute(event):
    if event.fwd_from:
        return
    if event.is_private:
        await event.edit("**╮ ❐  جـاري الغـاء كتمه  ❏╰**")
        await sleep(3)
        userid = event.chat_id
        replied_user = await event.client(GetFullUserRequest(userid))
        chat_id = event.chat_id
        if not is_muted(userid, chat_id):
            return await event.edit("**❐ ⋮ هذا المستخدم غير مكتوم هنا**")
        try:
            unmute(userid, chat_id)
        except Exception as e:
            await event.edit("حدث خطأ!\nالخطأ هو " + str(e))
        else:
            await event.edit("** - ❝ ⌊  تم رفـع الكتـم عـنه  𓆰.**")
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID,
                "#رفع_القيود\n"
        ...
        try:
            if is_muted(user.id, event.chat_id):
                ...
                try:
                    ...
                    return await eor(
                        event,
                        "هذا المستخدم غير مكتوم هنا~~",
                    )
        except Exception as e:
            return await eor(event, f"**خطأ : **`{str(e)}`")
        await eor(event, "** - ❝ ⌊  تم رفـع الكتـم عـنه  𓆰.**")
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID,
                "#رفع_القيود\n"
...
@zedthon.on(zelzal_cmd(pattern="طرد(?: |$)(.*)", command="kick"))
@zedthon.on(sudo_cmd(pattern="طرد(?: |$)(.*)", command="kick", allow_sudo=True))
async def kick(usr):
    if usr.fwd_from:
        return
    ...
    if not user:
        ...
        return
    zedl = await eor(usr, "**جـاري طرد...**")
    try:
        await usr.client.kick_participant(usr.chat_id, user.id)
        await sleep(0.5)
    except Exception as e:
        await zedl.edit(NO_PERM + f"\n{str(e)}")
        return
    if reason:
        await zedl.edit(
...
@zedthon.on(zelzal_cmd(pattern="تثبيت($| (.*))", command="pin"))
@zedthon.on(sudo_cmd(pattern="تثبيت($| (.*))", command="pin", allow_sudo=True))
async def pin(msg):
    if msg.fwd_from:
        return
...
@zedthon.on(zelzal_cmd(pattern="الغاء تثبيت($| (.*))", command="unpin"))
@zedthon.on(sudo_cmd(pattern="الغاء تثبيت($| (.*))", command="unpin", allow_sudo=True))
async def pin(msg):
    if msg.fwd_from:
        return
    if not msg.is_private:
