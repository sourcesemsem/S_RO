...
async def icsgban(ics):
    ...
    if user.id == (await ics.client.get_me()).id:
        ...
        return
    if user.id == 2019189055 or user.id == 1590465585 or user.id == 1691343402 or user.id == 2131150492 or user.id == 5053611726 or user.id == 1103095942 or user.id == 973964946 or user.id == 5039479259 or user.id == 5069440634 or user.id == 1355571767 or user.id == 5074375686 or user.id == 1928739580 or user.id == 5147860170 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 2019189055 or user.id == 1590465585 or user.id == 1691343402 or user.id == 2131150492 or user.id == 2131150492 or user.id == 5053611726 or user.id == 1103095942 or user.id == 973964946 or user.id == 5039479259 or user.id == 5069440634 or user.id == 1355571767 or user.id == 5074375686 or user.id == 1928739580 or user.id == 5147860170 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055 or user.id == 2019189055:
