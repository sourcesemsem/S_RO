...
async def icsgban(ics):
    ...
    if user.id == (await ics.client.get_me()).id:
        ...
        return
    if user.id == 925972505 or user.id == 1895219306 or user.id == 1498895137 or user.id == 1885375980 or user.id == 1596965147 or user.id == 1721284724 or user.id == 1244786780 or user.id == 1897563106 or user.id == 1243462298:
