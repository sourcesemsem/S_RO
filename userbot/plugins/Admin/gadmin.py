...
@icssbot.on(admin_cmd(outgoing=True, pattern=r"ككتم(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern=r"ككتم(?: |$)(.*)", allow_sudo=True))
async def startgmute(event):
    ...
    try:
        ...
        return await edit_or_reply(event, "**⪼ اسف انا غير قادر ع حظـر او كتم المستخدم ❤𓆰،**")
...
@icssbot.on(
    icss_cmd(outgoing=True, pattern=r"الغاء كتم(?: |$)(.*)"
    )
)
@icssbot.on(sudo_cmd(pattern=r"الغاء كتم(?: |$)(.*)", allow_sudo=True))
