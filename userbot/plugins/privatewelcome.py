...
@icssbot.on(admin_cmd(pattern="clearpwel$"))
@icssbot.on(sudo_cmd(pattern="clearpwel$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="listpwel$"))
@icssbot.on(sudo_cmd(pattern="listpwel$", allow_sudo=True))
