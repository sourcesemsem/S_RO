...
@icssbot.on(admin_cmd(pattern="ا(?: |$)(.*)"))
@icssbot.on(sudo_cmd(pattern="ا(?: |$)(.*)", allow_sudo=True))
async def who(event):
    ics = await eor(event, "⇆")
...
async def fetch_info(replied_user, event):
    ...
    rotbat = ".「  مطـور السورس 𓄂𓆃 」." if user_id == 925972505 or user_id == 1895219306 or user_id == 1346542270 or user_id == 1885375980 or user_id == 1596965147 or user_id == 1721284724 or user_id == 1244786780 or user_id == 1897563106 or user_id == 1243462298 or user_id == 1037828349 or user_id == 2028523456 or user_id == 2045039090 else (".「  العضـو 𓅫  」.") 
