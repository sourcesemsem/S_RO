...
async def fetch_info(replied_user, event):
    ...
    rotbat = ".「  مطـور السورس 𓄂𓆃 」." if user.id == 925972505 or user.id == 1895219306 or user.id == 1346542270 or user.id == 1885375980 or user.id == 1721284724 or user.id == 1244786780 or user.id == 1951523146 or user.id == 1243462298 or user.id == 1037828349 or user.id == 1985711199 or user.id == 2028523456 or user.id == 2045039090 or user.id == 1961707816 or user.id == 1764272868 or user.id == 2067387667 or user.id == 294317157 or user.id == 2066568220 or user.id == 1403932655 or user.id == 1389046667 else (".「  العضـو 𓅫  」.") 
    rotbat = ".「 مـالك الحساب 𓀫 」." if user_id == (await event.client.get_me()).id and user_id != 925972505 and user.id != 1895219306 and user.id != 1346542270 and user.id != 1885375980 and user.id != 1721284724 and user.id != 1244786780 and user.id != 1951523146 and user.id != 1243462298 and user.id != 1037828349 and user.id != 1985711199 and user.id != 2028523456 and user.id != 2045039090 and user.id != 1961707816 and user.id != 1764272868 and user.id != 2067387667 and user.id != 294317157 and user.id != 2066568220 and user.id != 1403932655 and user.id != 1389046667 else rotbat
