...
async def fetch_info(replied_user, event):
    ...
    rotbat = "「من مطـورين السورس 𓄂𓆃」" if user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 or user_id == 5502537272 else (".「  العضـو 𓅫  」.") 
    ...
    caption = f"<b> {Repthon_TEXT} </b>\n"
    caption += f"<b> ٴ•━─━─━─━─━─━─━─━─━• </b>\n"
    caption += f"<b> {RepthonM}| الاسـم    ⇦ </b> {first_name} {last_name}\n"
    caption += f"<b> {RepthonM}| المعـرف  ⇦ </b> {username}\n"
    caption += f"<b> {RepthonM}| الايـدي   ⇦ </b> <code>{user_id}</code>\n"
    caption += f"<b> {RepthonM}| الرتبـــه  ⇦ {rotbat} </b>\n"
    caption += f"<b> {RepthonM}| الصـور   ⇦ </b> {replied_user_profile_photos_count}\n"
    caption += f"<b> {RepthonM}|الحسـاب ⇦ </b> "
    caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
    caption += f"\n<b> {RepthonM}| الـمجموعات المشتـركة ⇦ </b> {common_chat} \n"
    caption += f"<b> {RepthonM}| البايـو    ⇦ </b> {user_bio} \n"
    caption += f"<b> ٴ•━─━─━─━─━─━─━─━─━• </b>\n"
