...
Heroku_cmd = (
    "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 - هيـروكو الفـارات](t.me/ZEDthon) 𓆪\n"
    "**⌔∮ قائـمه اوامر هيروكو :** \n"
...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            "**- عذرا لا يمكنك استخدام اوامر الفارات وهيروكو الا بعد اضافة كود هيروكو الى الفارات شرح الاضافة [اضغط هنا](https://t.me/Zed_Thon)**"
        )
    data = app.get_log()
    await edit_or_reply(
