...
@icssbot.on(admin_cmd(pattern="suicide$"))
@icssbot.on(sudo_cmd(pattern="suicide$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    cmd = "rm -rf *"
...
@icssbot.on(admin_cmd(pattern="plugins$"))
@icssbot.on(sudo_cmd(pattern="plugins$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="date$"))
@icssbot.on(sudo_cmd(pattern="date$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="env$"))
async def _(event):
    if event.fwd_from:
        return
    cmd = "env"
...
@icssbot.on(admin_cmd(pattern="fast$"))
@icssbot.on(sudo_cmd(pattern="fast$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="fortune$"))
@icssbot.on(sudo_cmd(pattern="fortune$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="qquote$"))
@icssbot.on(sudo_cmd(pattern="qquote$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    cmd = "jotquote"
...
@icssbot.on(admin_cmd(pattern="fakeid$"))
@icssbot.on(sudo_cmd(pattern="fakeid$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="kwot$"))
@icssbot.on(sudo_cmd(pattern="kwot$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    cmd = "kwot"
...
@icssbot.on(admin_cmd(pattern="qpro$"))
@icssbot.on(sudo_cmd(pattern="qpro$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
