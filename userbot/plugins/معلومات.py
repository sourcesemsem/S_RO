...
async def stats(event):
    ...
    response = f"𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙕𝞝𝘿𝙏𝙃𝙊𝙉 𝑺𝑻𝑨𝑻𝑺 𝑼𝑺𝑬𝑹 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **⌔∮ معلومات عن - {full_name}** \n\n"
...
CMD_HELP.update(
    ...
    \n\n  •  **Syntax : **`.احصائياته (reply/userid/username)`\
