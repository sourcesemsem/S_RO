# collage plugin for SOURCE 𝙕𝞝𝘿𝙏𝙃𝙊𝙉 by @sandy1709 edit by @zlzzl77
...
@icssbot.on(admin_cmd(pattern="collage(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="collage(?: |$)(.*)", allow_sudo=True))
