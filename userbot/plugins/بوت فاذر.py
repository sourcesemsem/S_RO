#𝙕𝙚𝙙𝙏𝙝𝙤𝙣 ®
#الملـف حقـوق وكتابـة زلـزال الهيبـه " شخصيـاً " مـاموجود لا  سورس اجنبـي ولا عـربي ⤶ @zzzzl1l خاص بسـورس ⤶ 𝙕𝙚𝙙𝙏𝙝𝙤𝙣
#تخمـط وماتذكـر الحقـوق اهينـك
...
@bot.on(admin_cmd(pattern="الانلاين تفعيل ?(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="الانلاين تفعيل ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
        ...
        try:
            ...
            async with bot.conversation(chat) as conv:
                try:
                    ...
                    return await python.edit("**❈╎قـم بإلغـاء الحظـر عـن بـوت فـاذر اولا @Botfather .. ثـم اعـد المحـاوله**")
...
@bot.on(admin_cmd(pattern="الانلاين تعطيل ?(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="الانلاين تعطيل ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    tgbotusername = Config.TG_BOT_USERNAME
...
@bot.on(admin_cmd(pattern="النبذة ?(.*)"))
@bot.on(sudo_cmd(pattern="النبذة ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    if not reply_to_id:
        return await edit_or_reply(
            event, "**╮ لتغييـر نبـذة بوتـك المسـاعد بدون الذهاب لبوت فـاذر ارسـل .النبذة + النبذة ...𓅫╰**"
        )
    chat = "@Botfather"
...
@bot.on(admin_cmd(pattern="الوصف ?(.*)"))
@bot.on(sudo_cmd(pattern="الوصف ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
    ...
    if not reply_to_id:
        return await edit_or_reply(
            event, "**╮ لتغييـر وصـف بوتـك المسـاعد بدون الذهاب لبوت فـاذر ارسـل .الوصف + الوصف ...𓅫╰**"
        )
    chat = "@Botfather"
...
@bot.on(admin_cmd(pattern="الاسم ?(.*)"))
@bot.on(sudo_cmd(pattern="الاسم ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
    ...
    if not reply_to_id:
        return await edit_or_reply(
            event, "**╮ لتغييـر اسـم بوتـك المسـاعد بدون الذهاب لبوت فـاذر ارسـل .الاسم + اسم البـوت ...🎟𓅫╰**"
        )
    chat = "@Botfather"
...
@bot.on(admin_cmd(pattern="الصورة$", outgoing=True))
@bot.on(sudo_cmd(pattern="الصورة$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
    if not reply_message:
        await edit_or_reply(event, "**╮ .الصورة بالـرد ﮼؏ الـٓصـورھہ لوضعـها بـروفايـل بـوتك المسـاعـد ...🎆𓅫╰**")
        return
    chat = "@Botfather"
