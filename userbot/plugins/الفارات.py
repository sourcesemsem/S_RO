...
@E_7_V - كتـابـة الملـف : بــاقــر روجــر"""
# بــاقــر_روجــر يولـد هههههههههههههههههههههههههه
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await bot.edit("**✾╎تم تغيـر المنطقـة الزمنيـه**\n **✾╎المتغير : دولـة مصـر 🇪🇬**\n\n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
        else:
            await bot.edit("**✾╎تم اعـادة تغيـر المنطقـة الزمنيـه**\n **✾╎المتغير : دولـة مصـر 🇪🇬**\n\n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
        heroku_var[variable] = vinfo
        ...
        if variable in heroku_var:
            ...
            await bot.edit("**✾╎تم اضافـة {} بنجـاح ☑️** \n**✾╎المضاف اليه :**\n `{}` \n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        heroku_var[variable] = vinfo
    elif input_str == "اسمي وقتي" or input_str == "اسم وقتي":
        variable = "AUTONAME"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await bot.edit("**✾╎تم تغييـر {} بنجـاح ☑️**\n**✾╎المتغيـر : ↶**\n `{}` \n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        ...
        if input_str:
            return await bot.edit("**✾╎عـذراً .. لايوجـد هنالك فـار بإسـم {} ؟!..**".format(input_str))
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await bot.edit("**✾╎تم حـذف {} بنجـاح ☑️**\n**✾╎المتغيـر المحـذوف : ↶**\n `{}` \n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, heroku_var[variable]))
...
async def variable(event):
    ...
    if input_str == "رمز الوقتي" or input_str == "رمز الاسم الوقتي":
        ...
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await bot.edit("**✾╎الفـار {} موجـود ☑️**\n**✾╎المتغيـر : ↶**\n `{}` \n**✾╎قنـاة السـورس : @Repthon**".format(input_str, heroku_var[variable]))
        else:
    ...
    elif input_str == "اسمي الوقتي" or input_str == "اسم وقتي":
        variable = "AUTONAME"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await bot.edit("**✾╎الفـار {} موجـود ☑️**\n**✾╎المتغيـر : ↶**\n `{}` \n**✾╎قنـاة السـورس : @Repthon**".format(input_str, heroku_var[variable]))
        ...
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await bot.edit("**✾╎المطـور {} موجـود 🧑🏻‍💻☑️**\n**✾╎ايدي المطـور : ↶**\n `{}` \n**✾╎قنـاة السـورس : @Repthon**".format(input_str, heroku_var[variable]))
        else:
            await bot.edit("**✾╎ المطـور {} غيـر موجـود 🧑🏻‍💻❌** \n**✾╎المتغيـر :**\n `{}` \n**✾╎قنـاة السـورس : @Repthon**".format(input_str, heroku_var[variable]))
...
async def variable(event):
    ...
    vmsr = "Africa/Cairo"
    heroku_var = app.config()
    zed = await edit_or_reply(event, "**✾╎جـاري أعـداد المنطقـه الزمنيـه لـ ريبـــثون 🌐...**")
    # All Rights Reserved for "Zedthon - UserBot" "زلـزال الهيبـه"
    if input_str == "العراق" or input_str == "عراق":
        variable = "TZ"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await bot.edit("**✾╎تم تغييـر المنطقـه الزمنيـه .. بنجـاح ☑️**\n**✾╎المتغير : ↶**\n دولـة `{}` 🇮🇶 \n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str))
        else:
            await bot.edit("**✾╎تم اضـافـة المنطقـه الزمنيـه .. بنجـاح ☑️**\n**✾╎المضـاف اليـه : ↶**\n دولـة `{}` 🇮🇶 \n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str))
...
async def zelzalll(event):
    ...
    if not previous_message:
        await edit_or_reply(event, "**بــاقــر**")
        return
    ...
    await asyncio.sleep(1.5)
    if variable in heroku_var:
        await bot.edit("**✾╎تـم رفـع**  [الشخـص🧑🏻‍💻](tg://user?id={})  **مطـور .. بنجـاح ☑️**\n**✾╎بصـلاحيات تحـكم كـامل بالاوامـر 🦾**\n\n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(user_id))
    else:
        await bot.edit("**✾╎تـم إعـادة رفـع**  [الشخـص🧑🏻‍💻](tg://user?id={})  **مطـور .. بنجـاح ☑️**\n**✾╎بصـلاحيات تحـكم كـامل بالاوامـر 🦾**\n\n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(user_id))
...
async def zelzalll(event):
    ...
    if previous_message:
	    ...
	    await asyncio.sleep(1.5)
	    if variable not in heroku_var:
	        return await bot.edit(f"**✾╎عـذراً .. فـار {input_str} غير موجود اصـلاً...**")
	
	    await bot.edit("**✾╎تـم تنزيـل**  [الشخـص🧑🏻‍💻](tg://user?id={})  **مطـور .. بنجـاح ☑️**\n**✾╎لـم يعد لديـه تحـكم بأوامـر البـوت 🥲**\n\n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(user_id))
	    del heroku_var[variable]
    ...
    if tosh.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await bot.edit("**✾╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**✾╎المتغيـر : ↶**\n `{}` \n**✾╎يتم الان اعـادة تشغيـل بـوت ريبـــثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
...
async def cmd(zelzallll):
    await eor(zelzallll, RogerVP_cmd)
