...
@icssbot.on(admin_cmd(pattern="warn (.*)"))
@icssbot.on(sudo_cmd(pattern="warn (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@icssbot.on(admin_cmd(pattern="warns$"))
@icssbot.on(sudo_cmd(pattern="warns$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
...
@icssbot.on(admin_cmd(pattern="resetwarns$"))
@icssbot.on(sudo_cmd(pattern="resetwarns$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
