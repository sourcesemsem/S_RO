...
@Rallsthon.on(QQ070_cmd(pattern="الاوامر"))
@Rallsthon.on(sudo_cmd(pattern="الاوامر", allow_sudo=True))
...
@Rallsthon.on(events.NewMessage(pattern=r"\.(.*)", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉](t.me/RallsThon) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉](t.me/RallsThon) 𓆪"
...
@Rallsthon.on(sudo_cmd(pattern="م3", allow_sudo=True))
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒](t.me/RallsThon) 𓆪")
...
@Rallsthon.on(QQ070_cmd("م4"))
@Rallsthon.on(sudo_cmd("م4", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م5"))
@Rallsthon.on(sudo_cmd("م5", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م6"))
@Rallsthon.on(sudo_cmd("م6", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م7"))
@Rallsthon.on(sudo_cmd("م7", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م8"))
@Rallsthon.on(sudo_cmd("م8", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م9"))
@Rallsthon.on(sudo_cmd("م9", allow_sudo=True))
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر التاك :** \n⪼ `.تاك ` \n⪼ `.للكل ` + الكلام \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒](t.me/RallsThon) 𓆪")
...
@Rallsthon.on(QQ070_cmd("م10"))
@Rallsthon.on(sudo_cmd("م10", allow_sudo=True))
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الكشف :** \n⪼ `.الايدي ` \n⪼ `.ايدي ` \n⪼ `.رابط الحساب ` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒](t.me/RallsThon) 𓆪")
...
@Rallsthon.on(QQ070_cmd("م12"))
@Rallsthon.on(sudo_cmd("م12", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م13"))
@Rallsthon.on(sudo_cmd("م13", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م14"))
@Rallsthon.on(sudo_cmd("م14", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م15"))
@Rallsthon.on(sudo_cmd("م15", allow_sudo=True))
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر النت :** \n⪼ `.بنك`  \n⪼ `.سرعه النت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒](t.me/RallsThon) 𓆪")
...
@Rallsthon.on(QQ070_cmd("م16"))
@Rallsthon.on(sudo_cmd("م16", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م17"))
@Rallsthon.on(sudo_cmd("م17", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م18"))
@Rallsthon.on(sudo_cmd("م18", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م25"))
@Rallsthon.on(sudo_cmd("م25", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م26"))
@Rallsthon.on(sudo_cmd("م26", allow_sudo=True))
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/RallsThon) 𓆪\n **⌔╎القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒](t.me/RallsThon) 𓆪")
...
@Rallsthon.on(QQ070_cmd("م27"))
@Rallsthon.on(sudo_cmd("م27", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م28"))
@Rallsthon.on(sudo_cmd("م28", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م29"))
@Rallsthon.on(sudo_cmd("م29", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("م33"))
@Rallsthon.on(sudo_cmd("م33", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("المطور"))
@Rallsthon.on(sudo_cmd("المطور", allow_sudo=True))
async def _(Ralls):
...
@Rallsthon.on(QQ070_cmd("رابط الحذف"))
@Rallsthon.on(sudo_cmd("رابط الحذف", allow_sudo=True))
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/RallsThon) 🗑♻️𓆪\n**𓍹━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
@Rallsthon.on(QQ070_cmd(pattern="رفع جلب(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="رفع جلب(?: |$)(.*)", allow_sudo=True))
...
@Rallsthon.on(QQ070_cmd(pattern="رفع مرتي(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="رفع مرتي(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@Rallsthon.on(QQ070_cmd(pattern="رفع تاج(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="رفع تاج(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@Rallsthon.on(QQ070_cmd(pattern="رفع بكلبي(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="رفع بكلبي(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@Rallsthon.on(QQ070_cmd(pattern="رفع بقلبي(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="رفع بقلبي(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@Rallsthon.on(QQ070_cmd(pattern="رفع جريذي(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="رفع جريذي(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@Rallsthon.on(QQ070_cmd(pattern="رفع فرخ(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="رفع فرخ(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
    """ For .link command, generates a link to the user's PM with a custom text. """
    user, custom = await get_user_from_event(mention)
    if not user:
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه الحب(?:\s|$)([\s\S]*)"))
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه الانوثه(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه الغباء(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه الانحراف(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه المثليه(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه النجاح(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه الكراهيه(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع ورع(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع مزه(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع مطي(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع حمار(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخدم ⪼ • ** [{Rallsth2}](tg://user?id={user.id}) \n☑️ **╎ تم رفعـه حمار جحا 😂🐴.** \n**🤵‍♂️ ╎ بواسطـه  :** {my_mention} ")
@Rallsthon.on(QQ070_cmd(pattern="رفع زباله(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع منشئ(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع مدير(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع كواد(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع مرتبط(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع مرتبطه(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع حبيبي(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع خطيبتي(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="رفع صاك(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
    ...
    my_mention = f"[{me.first_name}](tg://user?id={me.id})"
    await edit_or_reply(mention, f"**🚹 ╎ المستخدم ⪼ • ** [{Rallsth2}](tg://user?id={user.id}) \n☑️ **╎  تم رفعـه صاك 🤴 .** \n**🤵‍♂️ ╎ بواسطـه  : ** {my_mention} ")
@Rallsthon.on(QQ070_cmd(pattern="رفع صاكه(?:\s|$)([\s\S]*)"))
async def Ralls(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@Rallsthon.on(QQ070_cmd(pattern="نسبه الانوثه(?: |$)(.*)"))
@Rallsthon.on(sudo_cmd(pattern="نسبه الانوثه(?: |$)(.*)", allow_sudo=True))
async def permalink(mention):
...
DEFAULTUSER = "Ralls"
CAT_IMG = "https://telegra.ph/file/57d51af1ca93d8cc8a958.jpg"
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝐑𝐀𝐈𝐈𝐒 - 𝑫𝑬𝑽??𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "


@Rallsthon.on(QQ070_cmd(outgoing=True, pattern="$مطور"))
@Rallsthon.on(sudo_cmd(pattern="$مطور", allow_sudo=True))
async def dev(alive):
    if alive.fwd_from:
        return
