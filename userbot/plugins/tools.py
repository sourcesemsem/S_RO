...
@icssbot.on(admin_cmd(pattern="(scan|scani)$"))
@icssbot.on(sudo_cmd(pattern="(scan|scani)$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with event.client.conversation(chat) as conv:
        ...
        if input_str == "scan":
            ...
            await icssevent.delete()
            await event.client.send_file(
                event.chat_id, response3.media, reply_to=(await reply_id(event))
            )


@icssbot.on(admin_cmd(pattern=r"decode$", outgoing=True))
@icssbot.on(sudo_cmd(pattern=r"decode$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="barcode ?(.*)"))
@icssbot.on(sudo_cmd(pattern="barcode ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    icssevent = await edit_or_reply(event, "...")
    start = datetime.now()
    input_str = event.pattern_match.group(1)
    ...
    try:
        ...
        await icssevent.edit(str(e))
        return
    end = datetime.now()
    ms = (end - start).seconds
    await icssevent.edit("Created BarCode in {} seconds".format(ms))
    await asyncio.sleep(5)
    await catevent.delete()


@icssbot.on(admin_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="cal (.*)"))
@icssbot.on(sudo_cmd(pattern="cal (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@icssbot.on(admin_cmd(pattern="currency (.*)"))
@icssbot.on(sudo_cmd(pattern="currency (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@icssbot.on(admin_cmd(pattern="currencies$"))
@icssbot.on(sudo_cmd(pattern="currencies$", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="ifsc (.*)"))
@icssbot.on(sudo_cmd(pattern="ifsc (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@icssbot.on(admin_cmd(pattern="color (.*)"))
@icssbot.on(sudo_cmd(pattern="color (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@icssbot.on(admin_cmd(pattern="xkcd ?(.*)"))
@icssbot.on(sudo_cmd(pattern="xkcd ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    icssevent = await edit_or_reply(event, "`processiong...........`")
    input_str = event.pattern_match.group(1)
    xkcd_id = None
    if input_str:
...
Year: {}""".format(
        ...
        await icssevent.edit(output_str, link_preview=True)
    else:
        await icssevent.edit("xkcd n.{} not found!".format(xkcd_id))
