...
class Config(object):
    ...
    DIGITAL_PIC = os.environ.get("DIGITAL_PIC", "https://graph.org/file/63a826d5e5f0003e006a0.jpg")
    DEFAULT_PIC = os.environ.get("DEFAULT_PIC", "https://graph.org/file/63a826d5e5f0003e006a0.jpg")
